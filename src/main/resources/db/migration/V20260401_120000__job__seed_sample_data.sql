...
-- =====================================================================
-- 1. TẠO EMPLOYER TRƯỚC
-- =====================================================================
INSERT INTO employer (
    employer_id, company_id, email, name, surname, status, verification_level, level
) VALUES (
             'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1',
             (SELECT company_id FROM company WHERE company_name = 'FPT Software' LIMIT 1),
    'hr.manager@fpt.com', 'Admin', 'Recruiter', 'active', 'lv3', 'level1'
...
INSERT INTO job (
    ...
    E'- Tham gia phát triển, thiết kế và triển khai các dự án phần mềm quy mô lớn cho khách hàng Nhật Bản, Mỹ và Châu Âu trong lĩnh vực Tài chính - Ngân hàng.\n- Phân tích yêu cầu nghiệp vụ, thiết kế kiến trúc hệ thống Microservices, xây dựng RESTful API phục vụ hàng triệu người dùng.\n- Phát triển backend sử dụng Java 11/17, Spring Boot, Spring Cloud, Hibernate/JPA, kết hợp với Kafka, Redis, Elasticsearch.\n- Tối ưu hóa hiệu năng hệ thống, xử lý các vấn đề về concurrency, caching, database indexing trên PostgreSQL/Oracle.\n- Thực hiện code review, mentor các thành viên Junior/Middle, đảm bảo chất lượng source code theo chuẩn Clean Code và SOLID.\n- Tham gia vào quy trình CI/CD, triển khai ứng dụng trên môi trường Docker, Kubernetes, AWS.\n- Làm việc trực tiếp với khách hàng nước ngoài (Onsite ngắn hạn/dài hạn) để nhận yêu cầu và trình bày giải pháp kỹ thuật.',
        ...
        'Senior', 'Full-time', 'Hồ Chí Minh', 1500.00, 2500.00, 3.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '1 hours'
    ),
    (
        ...
        'https://res.cloudinary.com/dhiz9hdeq/image/upload/v1776047474/jobs/covers/vng_group_logo_d7c5ma.jpg',
        'Middle', 'Full-time', 'Hồ Chí Minh', 1200.00, 2000.00, 2.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '5 hours'
    ),
    (
        ...
        'https://res.cloudinary.com/dhiz9hdeq/image/upload/v1776047533/jobs/covers/1692104431985_udggxa.jpg',
        'Middle', 'Full-time', 'Hà Nội', 1500.00, 2800.00, 2.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '1 days'
    ),
    (
        gen_random_uuid(), (SELECT company_id FROM company WHERE company_name = 'FPT Software' LIMIT 1),
    ...
    (
        ...
        'https://res.cloudinary.com/dhiz9hdeq/image/upload/v1776047533/jobs/covers/1692104431985_udggxa.jpg',
        'Senior', 'Full-time', 'Hồ Chí Minh', 1800.00, 3200.00, 4.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '4 days'
    ),
    (
        gen_random_uuid(), (SELECT company_id FROM company WHERE company_name = 'FPT Software' LIMIT 1),
    ...
    (
        ...
        'https://res.cloudinary.com/dhiz9hdeq/image/upload/v1776047533/jobs/covers/1692104431985_udggxa.jpg',
        'Middle', 'Full-time', 'Hà Nội', 900.00, 1600.00, 2.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '7 days'
    ),
    (
        gen_random_uuid(), (SELECT company_id FROM company WHERE company_name = 'FPT Software' LIMIT 1),
        ...
        'https://res.cloudinary.com/dhiz9hdeq/image/upload/v1776047417/jobs/covers/fpt_software_logo_bwsxp9.jpg',
        'Junior', 'Full-time', 'Đà Nẵng', 500.00, 900.00, 1.0, 'active', 'e1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', NOW() - INTERVAL '8 days'
    );
